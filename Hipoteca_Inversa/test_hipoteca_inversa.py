...
class PruebasHipotecaInversa(unittest.TestCase):
    ...
    def test_calculos_hipoteca_inversa_1(self):
        ...
        ingreso_mensual = hipoteca_inversa.calcular_ingreso_mensual(edad, precio_de_la_vivienda, porcentaje_precio_real, total_cuotas, tasa_de_interes_mensual)
        deuda_total = hipoteca_inversa.calcular_deuda_total(ingreso_mensual, tasa_de_interes_mensual, total_cuotas, porcentaje_precio_real)
    ...
    def test_edad_negativa(self):
        ...
        precio_de_la_vivienda = 619_424_917
        porcentaje_precio_real = 40
        valor_de_la_hipoteca = 247769_967
